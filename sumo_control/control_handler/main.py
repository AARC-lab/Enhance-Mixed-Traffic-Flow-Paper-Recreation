...
if __name__ == "__main__":
    ...
    if not without_ramp:
        ...
        traci.start([sumoBinary, "-c", "/home/ruby/Nazmus Shakib/AARC Lab/Draft Project/deployment/environment/main_config.sumocfg"])
    if without_ramp:
        ...
        traci.start([sumoBinary, "-c", "/home/ruby/Nazmus Shakib/AARC Lab/Draft Project/deployment/environment/main_config_without_ramp.sumocfg"])
